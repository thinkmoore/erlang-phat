...
master(UknownMessage, State) ->
    ?debugFmt("master got unknown message: ~p~n", [UknownMessage]),
...
replica(UknownMessage, State) ->
    ?debugFmt("replica got unknown message: ~p~n", [UknownMessage]),
...
viewChange(UknownMessage, State) ->
    ?debugFmt("view changing replica got unknown/invalid message: ~p~n", [UknownMessage]),
